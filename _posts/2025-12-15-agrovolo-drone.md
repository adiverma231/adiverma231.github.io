...
![STM32](/assets/images/prev_board){: .w-75 .mx-auto .d-block }

- I used an STM32F4 as the microcontroller for this project

### Stepper Driver
![Stepper Schematic](/assets/images/prev_board){: .w-75 .shadow .rounded-10 }

- Two TMC2209 steppermotor drivers powered by 24V input and communicates via UART to the STM32

### Cooling Fans
![Cooling Fans](/assets/images/prev_board){: .w-75 .shadow .rounded-10 }
...
### USB Connector
![USB Connector](assets/images/prev_board){: .w-75 .shadow .rounded-10 }
...
### EEPROM
![EEPROM](assets/images/prev_board){: .w-75 .shadow .rounded-10 }
...
## All circuits
![Other Circuitry](assets/images/prev_board){: .w-75 .shadow .rounded-10 }
